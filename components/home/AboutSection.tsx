        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              {[
                { title: 'Premium Quality', desc: 'Rigorous quality control at every step' },
                { title: 'Scalable Volume', desc: 'From containers to bulk shipments' },
                { title: 'Global Compliance', desc: 'Meeting international standards' },
                { title: 'Reliable Logistics', desc: 'On-time delivery guaranteed' }
              ].map((item, idx) => (
