...
const About: React.FC = () => {
    ...
    return (
        <div className="overflow-x-hidden bg-transparent">
            ...
            <section className="min-h-screen flex flex-col justify-center py-20 bg-white dark:bg-gray-900 transition-colors duration-300 overflow-hidden">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        <AnimatedSection type="slide-left">
                            <div className="relative group">
                                <div className="absolute -inset-4 bg-blue-500/10 rounded-full blur-3xl -z-20"></div>
                        ...
                        <AnimatedSection type="slide-right" delay={200}>
                            <div className="flex gap-6 md:gap-8 h-full">
                                ...
                                <div className="flex flex-col justify-center">
                                    ...
                                    <p className="text-lg text-text-sub dark:text-gray-300 mb-8 leading-relaxed text-justify md:text-left">
                                        {t('about.vision_desc')}
                                    </p>
            ...
            <section className="min-h-screen flex flex-col justify-center py-20 bg-gray-50 dark:bg-gray-800/50 backdrop-blur-sm transition-colors duration-300 overflow-hidden">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        <AnimatedSection type="slide-left" className="order-2 lg:order-1">
                             <div className="flex gap-6 md:gap-8 h-full">
                                ...
                                <div className="flex flex-col justify-center">
                                    <h2 className="text-4xl md:text-5xl uppercase font-black text-text-main dark:text-white mb-8">
                                        {t('about.core_value_title')}
                                    </h2>
                                    <div className="grid gap-6">
                                        {[1, 2, 3, 4].map((i) => (
                                            <div key={i} className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
                                                <strong className="text-xl text-text-main dark:text-white mb-2 block text-fastway-orange">
                                                    {t(`about.cv_${i}_title`)}
                                                </strong>
                                                <span className="text-text-sub dark:text-gray-300 block">
                                                    {t(`about.cv_${i}_desc`)}
                                                </span>
                                            </div>
                                        ))}
                        ...
                        <AnimatedSection type="slide-right" delay={200} className="order-1 lg:order-2">
                             <div className="relative group">
                                <div className="absolute inset-0 bg-gray-200 dark:bg-gray-700 rounded-3xl transform translate-x-4 translate-y-4 -z-10 transition-transform duration-500 group-hover:translate-x-6 group-hover:translate-y-6"></div>
                                <div className="absolute -inset-4 bg-amber-500/10 rounded-full blur-3xl -z-20"></div>
                                <div className="relative overflow-hidden rounded-2xl shadow-2xl aspect-[4/3]">
                                    <img 
