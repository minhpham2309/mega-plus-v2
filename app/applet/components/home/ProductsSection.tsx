      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {products.map((product) => (
            <div key={product.id} className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 border border-gray-100 flex flex-col group">
              {/* Image Area */}
          ...
          {/* Catalog Card */}
          <div className="bg-[#15803D] rounded-3xl overflow-hidden shadow-lg flex flex-col items-center justify-center text-center p-8 relative group">
