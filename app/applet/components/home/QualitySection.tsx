          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
              <div className="bg-gray-50 rounded-2xl p-4 flex flex-col items-center justify-center text-center border border-gray-100">
                ...
                <span className="text-xs font-bold text-gray-800">ISO 22000</span>
              </div>
              <div className="bg-gray-50 rounded-2xl p-4 flex flex-col items-center justify-center text-center border border-gray-100">
                <Award className="w-6 h-6 text-[#16A34A] mb-2" />
                <span className="text-xs font-bold text-gray-800">HACCP</span>
              </div>
              <div className="bg-gray-50 rounded-2xl p-4 flex flex-col items-center justify-center text-center border border-gray-100">
                <Leaf className="w-6 h-6 text-[#16A34A] mb-2" />
                <span className="text-xs font-bold text-gray-800">GlobalGAP</span>
              </div>
              <div className="bg-gray-50 rounded-2xl p-4 flex flex-col items-center justify-center text-center border border-gray-100">
                <CheckCircle className="w-6 h-6 text-[#16A34A] mb-2" />
                <span className="text-xs font-bold text-gray-800">FDA</span>
              </div>
            </div>
            ...
            <div className="bg-[#D1F4E0] rounded-[40px] p-10 lg:p-16 relative z-10">
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white rounded-3xl p-8 shadow-sm">
                  ...
                  <div className="text-sm text-gray-500 font-medium">Traceability</div>
                </div>
                <div className="bg-white rounded-3xl p-8 shadow-sm">
                  <div className="text-4xl font-black text-[#16A34A] mb-2">24/7</div>
                  <div className="text-sm text-gray-500 font-medium">Quality Monitoring</div>
                </div>
                <div className="bg-white rounded-3xl p-8 shadow-sm">
                  <div className="text-4xl font-black text-[#16A34A] mb-2">50+</div>
                  <div className="text-sm text-gray-500 font-medium">Quality Checkpoints</div>
                </div>
                <div className="bg-white rounded-3xl p-8 shadow-sm">
                  <div className="text-4xl font-black text-[#16A34A] mb-2">0%</div>
                  <div className="text-sm text-gray-500 font-medium">Compromise</div>
                </div>
              </div>
            </div>
