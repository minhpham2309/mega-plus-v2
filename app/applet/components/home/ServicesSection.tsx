...
import { Leaf, Package, Truck, Ship, FileText, MessageSquare, Check } from 'lucide-react';
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {services.map((service) => (
            <div key={service.id} className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-sm hover:bg-white/10 transition-colors duration-300 group">
          ...
          {/* CTA Card */}
          <div className="bg-[#F59E0B] rounded-3xl p-8 flex flex-col justify-center relative overflow-hidden group">
